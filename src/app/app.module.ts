...
import { selectLoadingIndicatorExtension } from "./formly-types/select-loader.extensions";
...
@NgModule({
  ...
  imports: [
    ...
    FormlyModule.forRoot({
      ...
      extensions: [
        {
          name: "select-loading-indicator",
          extension: selectLoadingIndicatorExtension
        }
      ]
    }),
